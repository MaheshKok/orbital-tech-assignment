...
import { transformToChartData, calculateTotalCredits } from '../../utils/chartDataTransform';
...
export function Dashboard() {
  ...
  const chartData = useMemo(() => {
    ...
    return transformToChartData(data.usage);
  }, [data?.usage]);

  // Calculate summary stats
  const stats = useMemo(() => {
    if (!data?.usage) return { total: 0, count: 0, reportCount: 0 };
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Credit Usage Dashboard</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="card p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{stats.reportCount}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card p-6 mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Daily Credit Usage</h2>
              <p className="text-sm text-gray-500">Credits consumed per day in the billing period</p>
            </div>
          </div>
        ...
        <div className="card p-6">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">
              Click on column headers to sort. Click three times to reset to original order.
            </p>
          </div>
