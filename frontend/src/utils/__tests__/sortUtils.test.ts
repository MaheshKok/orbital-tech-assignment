...
describe('sortUsageData', () => {
  const mockData: UsageItem[] = [
    { message_id: 1, timestamp: '2024-04-29T02:08:29Z', report_name: 'Report B', credits_used: 50 },
    { message_id: 2, timestamp: '2024-04-29T03:00:00Z', report_name: 'Report A', credits_used: 30 },
    { message_id: 3, timestamp: '2024-04-29T04:00:00Z', credits_used: 10 },
    { message_id: 4, timestamp: '2024-04-29T05:00:00Z', report_name: 'Report C', credits_used: 20 },
  ...
  describe('sorting by credits_used', () => {
    it('should sort ascending', () => {
      const sortOrder: SortEntry[] = [{ column: 'credits_used', direction: 'asc' }];
    ...
    it('should sort descending', () => {
      const sortOrder: SortEntry[] = [{ column: 'credits_used', direction: 'desc' }];
      const result = sortUsageData(mockData, sortOrder, originalIndices);
  ...
  describe('sorting by report_name', () => {
    it('should sort ascending with empty names at the end', () => {
      const sortOrder: SortEntry[] = [{ column: 'report_name', direction: 'asc' }];
      const result = sortUsageData(mockData, sortOrder, originalIndices);
    ...
    it('should sort descending with empty names at the end', () => {
      const sortOrder: SortEntry[] = [{ column: 'report_name', direction: 'desc' }];
      const result = sortUsageData(mockData, sortOrder, originalIndices);
  ...
  describe('multi-column sorting', () => {
    it('should sort by primary then secondary column', () => {
      ...
      const dataWithDuplicates: UsageItem[] = [
        { message_id: 1, timestamp: '2024-04-29T01:00:00Z', report_name: 'Report A', credits_used: 50 },
        { message_id: 2, timestamp: '2024-04-29T02:00:00Z', report_name: 'Report A', credits_used: 30 },
        { message_id: 3, timestamp: '2024-04-29T03:00:00Z', report_name: 'Report B', credits_used: 50 },
        { message_id: 4, timestamp: '2024-04-29T04:00:00Z', report_name: 'Report B', credits_used: 30 },
      ];
