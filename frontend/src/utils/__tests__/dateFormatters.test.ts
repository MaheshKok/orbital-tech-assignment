...
describe('dateFormatters', () => {
  describe('formatTimestamp', () => {
    ...
    it('should handle timestamps with different times', () => {
      expect(formatTimestamp('2024-05-01T14:30:00.000Z')).toBe('01-05-2024 14:30');
      expect(formatTimestamp('2024-12-25T00:00:00.000Z')).toBe('25-12-2024 00:00');
      expect(formatTimestamp('2024-01-01T23:59:59.000Z')).toBe('01-01-2024 23:59');
    });

    it('should pad single-digit days and months', () => {
      expect(formatTimestamp('2024-01-05T09:05:00.000Z')).toBe('05-01-2024 09:05');
    });
  });
